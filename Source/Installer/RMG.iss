...
#define MyAppName "CMG-K"
#define MyAppPublisher "CMG-K Contributors"
#define MyAppURL "https://github.com/crossn/CMG-K"
#define MyAppExeName "CMG-K.exe"
...
AppId={{6CA901CC-0BCB-4B7B-98A5-B4270B47B2AF}
AppName={#MyAppName}
AppVersion={#MyAppVer}
...
OutputDir={#MyOutDir}
OutputBaseFilename=CMG-K-Setup-Windows64-{#MyAppVer}
